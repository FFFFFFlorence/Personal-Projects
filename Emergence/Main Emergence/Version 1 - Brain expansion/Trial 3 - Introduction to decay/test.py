...
while running:
    ...
    if spawn_timer > 30:
        ...
        for gx, gy in occupied:
            ...
            top_left = (gx - 1, gy - 1) in occupied
            right = (gx + 1, gy) in occupied
            top_right = (gx + 1, gy - 1) in occupied
            ...
            # This rule triggers when a pixel is the middle of a 3-pixel line.
            ...
            if not did_remove:
                ...
                # If it's a vertical pair end, grow horizontally.
                if up ^ down:
